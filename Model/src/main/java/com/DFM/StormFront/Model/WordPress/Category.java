...
public class Category
{
	...
	public Category fromJSON(String source, String sourceType) throws Exception {
...
/*	public static ArrayList<Category> ListFromJson(String json)
	{
	...
	public final void setparent(int value)
	{
		parent = value;
	}
